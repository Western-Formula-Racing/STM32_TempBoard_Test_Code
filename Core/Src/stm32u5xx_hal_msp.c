...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB0     ------> ADC1_IN15
    */
    GPIO_InitStruct.Pin = Temp6_Pin|Temp5_Pin|VBUS_SENSE_Pin|Temp3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Temp2_Pin|Temp1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(GPIOC, Temp6_Pin|Temp5_Pin|VBUS_SENSE_Pin|Temp3_Pin);

    HAL_GPIO_DeInit(GPIOA, Temp2_Pin|Temp1_Pin);

    HAL_GPIO_DeInit(Temp4_GPIO_Port, Temp4_Pin);
